...
import {
  ...
  MessageCircle, Share2, Check, Search, Images, ArrowRight,
} from "lucide-react";
  ...
  return (
    <div className="w-full max-w-2xl mx-auto space-y-6">
      ...
      <div className="flex items-center justify-center gap-1 rounded-full border border-border bg-muted p-1 w-fit mx-auto">
        <span className="flex items-center gap-1.5 rounded-full px-4 py-1.5 text-sm font-medium bg-background text-foreground shadow-sm">
          <Download className="h-3.5 w-3.5" />
          {t(tr.search.tab_download, lang)}
        </span>
        <a href="/tiktok-slide" className="flex items-center gap-1.5 rounded-full px-4 py-1.5 text-sm font-medium text-muted-foreground transition-all hover:bg-background hover:text-foreground">
          <Images className="h-3.5 w-3.5" />
          Slideshow
        </a>
        <a href="/tiktok-search" className="flex items-center gap-1.5 rounded-full px-4 py-1.5 text-sm font-medium text-muted-foreground transition-all hover:bg-background hover:text-foreground">
